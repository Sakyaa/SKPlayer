...
@interface MonitoringSimplePlayerView ()
...
@implementation MonitoringSimplePlayerView {
    NSString *_title;
    NSString *_videoURL;
}
...
- (void)playVideo {
    ...
    _player = [[IJKFFMoviePlayerController alloc] initWithContentURL:[NSURL URLWithString:_videoURL] withOptions:options];
